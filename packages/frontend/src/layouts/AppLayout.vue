    ...
    <nav class="w-[250px] h-screen bg-white p-5 flex flex-col justify-between">
      ...
      <div class="">
        <div class="flex flex-col gap-2">
          ...
          <a href="" class="transition ease-in-out flex items-center gap-3 p-3 rounded bg-red-100 text-red-500 hover:bg-red-500 hover:text-red-100" @click.prevent="logUserOut()">
